...
**Status:** Complete. All seven phases delivered. Loading real NAMASTE and ICD-11 releases remains blocked on licensing and format.
...
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Does an official NAMASTE → ICD-11 TM2 mapping exist?           | Yes. Under the WHO–Ministry of Ayush donor agreement (2020–2025), 1,941 national Ayush morbidity codes were mapped, and TM2 was released on the WHO ICD-11 Browser in February 2025. _Source: search summary of the IJAR 2025 roadmap paper; the full text is paywalled and was not read._ | SP2 does not curate mappings from nothing. It imports an authoritative map and supports review of local corrections. Roughly halves the curation scope anticipated in `planning.md` §15. |
...
- [x] **T24** Terminology search and browse
- [x] **T25** Auto-code preview
- [x] **T26** Curation console

...
Roles: **C** = clinician · **F** = front-desk / records · **P** = patient · **A** = hospital admin · **X** = platform admin
...
Feature 7 deserves emphasis: it converts your compliance burden into the hospital's compliance *relief*. It is likely your strongest commercial argument, and it costs little once SP2 and SP3 exist.
...
### Prescriptions (C)
- Ayurvedic prescription: formulation, dose, *anupana* / vehicle, timing relative to food, duration, special instructions
